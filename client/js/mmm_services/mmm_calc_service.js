...
module.exports = function(app) {
  app.factory('mmmCalcs', function() {
    return function() {
      return {
        //calculate mean
        mean: function(inputData) {
          return inputData.reduce(function(pv, cv) { return pv + cv; }, 0) / inputData.length;
        },

        //calculate median
        median: function(inputData) {
          inputData = inputData.map(Number).sort(function(a, b) {return a - b;});
